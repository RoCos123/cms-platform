  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        {/* Setările (antet, subsol, SEO) apar pe toate paginile, deci butonul
            duce la prima pagină — locul unde se văd cel mai bine laolaltă. */}
        <LinkVeziPeSite href="/" eticheta="Vezi site-ul" />
      </div>
