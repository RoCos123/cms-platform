...
export function ToastProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <ToastContext.Provider value={value}>
      ...
      {/*
        Regiunea trebuie să existe în pagină înainte să apară primul mesaj — un
        aria-live montat odată cu conținutul nu e anunțat de cititoarele de ecran.
      */}
      <div
        role="status"
        aria-live="polite"
      ...
      >
        {toasts.map((toast) => (
          <div
            ...
            onBlurCapture={() => scheduleDismiss(toast.id)}
            className={cn(
